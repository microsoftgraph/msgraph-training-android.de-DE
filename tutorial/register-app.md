...
1. Wählen Sie **Registrieren** aus. Kopieren Sie auf der Seite mit dem **Android-Graph-Lernprogramm** den Wert der **Anwendungs-ID (Client)** , und speichern Sie ihn, dann benötigen Sie ihn im nächsten Schritt.
